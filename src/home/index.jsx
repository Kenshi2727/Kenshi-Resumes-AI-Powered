            ...
            <div className={(theme === 'light') ? 'bg-[url("../textures/batthern.png")]' : ''}>
                <div className='min-h-screen flex justify-center items-center'>
                    <div className='flex flex-col gap-2 mt-10 place-items-center'>
                        ...
                        <h3 className={(theme === 'light') ? 'text-center font-medium text-xs sm:text-base typing' : 'text-center font-medium text-xs sm:text-base typing'}>"Leverage the potential of AI to set yourself apart from the competition."</h3>
